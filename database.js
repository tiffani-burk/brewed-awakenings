...
//exports Product data in form of an array with product objects in it
export const getProducts = () => {
    return database.products.map(product => ({...product}))
}
//exports employee data in form of an array with employee objects in it
export const getEmployees = () => {
    return database.employees.map(employee => ({...employee}))
}
//exports order data in form of an array with order objects in it
